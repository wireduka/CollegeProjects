...
public class Scheduler implements Observer {
	...
	public void onObserverSignal(EventType event) {
		switch(event) {
			...
			case TABLE:	break;							// Left unused for further software implementation
		}
	}
	
	// Scheduler logic, this method is called on each observer signal
	private void processEvents() {
		// Queue flights that are ready to depart
